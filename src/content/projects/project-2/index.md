...
2. Inhaling and Exhaling Rates are recorded using air pressure sensors and uploaded to a database using a Wi-Fi module in real-time, data is fetched, visualized and clustered (K Means), using unsupervised machine learning algorithms. 84 percent accuracy was achieved
